...
def encrypt(message):
	...
	for letter in message:
		if letter != ' ':
			...
			# Looks up the dictionary and adds the corresponding morse code along with a space to separate
...
def main():
	message = "Backend Developer - Gafari Oladele Salaudeen"
	result = encrypt(message.upper())
	print (result)

	message = result
	result_two = decrypt(message)
	print (result_two)
